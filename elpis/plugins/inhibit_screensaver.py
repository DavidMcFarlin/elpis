...
class InhibitScreensaverPlugin(ElpisPlugin):
    ...
    def on_prepare(self):
        self._elpis_app = Gio.Application.get_default()
    ...
    def _inhibit(self):
        ...
        self._cookie = self._elpis_app.inhibit(
            self.window,
            suspend | idle,
    ...
    def _uninhibit(self):
        if self._cookie != 0:
            self._elpis_app.uninhibit(self._cookie)
