...
# Copyright (C) 2026 Elpis contributors
...
class BookmarksDialog(Gtk.Dialog):
    ...
    def _reload(self):
        self.worker_run(self.elpis.pandora.get_bookmarks, (), self._populate, 'Loading bookmarks…')
    ...
    def _build_song_row(self, bookmark):
        ...
        return self._build_row(primary, secondary,
                               lambda: self.elpis.pandora.delete_song_bookmark(bookmark.bookmarkToken))

    def _build_artist_row(self, bookmark):
        primary = bookmark.artist or _('(unknown artist)')
        return self._build_row(primary, '',
                               lambda: self.elpis.pandora.delete_artist_bookmark(bookmark.bookmarkToken))
