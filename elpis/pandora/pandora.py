    ...
    def sub_message(self):
        ...
        if value == 1:
            ...
            return ('Pandora is not available in your country.\n'
                    'If you wish to use Pandora you must configure your system or Elpis proxy accordingly.')
        elif value == 13:
            return ('Out of sync. Correct your system\'s clock.\n'
                    'If the problem persists it may indicate a Pandora API change.\nA Elpis update may be required.')
        if value == 1000:
...
class Pandora:
    ...
    def set_audio_quality(self, fmt):
        ...
        :param fmt: An audio quality format from :py:data:`elpis.pandora.data.valid_audio_formats`
        """
    ...
    def connect(self, client, user, password):
        ...
        :param client:   The client ID from :py:data:`elpis.pandora.data.client_keys`
