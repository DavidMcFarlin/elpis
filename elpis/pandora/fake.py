...
TEST_FILE = "https://github.com/DavidMcFarlin/elpis/testfile.aac"
...
class FakePandora(Pandora):
    ...
    def show_fail_window(self):
        ...
        self.window.set_title("Elpis failure tester")
    ...
    def makeFakeSong(self, stationId):
        ...
        return {
            ...
            'songDetailUrl': 'https://github.com/DavidMcFarlin/elpis/',
            'albumDetailUrl':'https://github.com/DavidMcFarlin/elpis/',
            'albumArtUrl':'https://github.com/DavidMcFarlin/elpis/img/elpis_logo.png',
            'songExplorerUrl':'https://github.com/DavidMcFarlin/elpis/test-song.xml',
        }
