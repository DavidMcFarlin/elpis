...
class ElpisPluginRow(Gtk.ListBoxRow):
...
@Gtk.Template(resource_path='/io/github/DavidMcFarlin/Elpis/ui/PreferencesElpisDialog.ui')
class PreferencesElpisDialog(Gtk.Dialog):
    __gtype_name__ = "PreferencesElpisDialog"
